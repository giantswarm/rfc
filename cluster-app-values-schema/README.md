...
- [Recommendations that are not requirements](#recommendations)
...
And then in the Helm template, fall back to the default if no explicit value is defined:
...
Or the same in the autogenerated `values.yaml`:
